...
export default function Home() {
  ...
  const navItems = [
    ...
    { name: currentNav.tools, link: "#tools" },
    {
      ...
      link: "https://drive.google.com/file/d/1yxWz8V7Mq6hF3AbrCbKcRB3rsCl4hXz9/view?usp=sharing"
    },
  ];
